/*
  ...
  - Select all columns from the reservations table, all columns from the properties table, and the average
  ...
  - These will end up being filtered by either "Upcoming Reservations" or "Past Reservations", so only get
    reservations where the end_date is in the past.
